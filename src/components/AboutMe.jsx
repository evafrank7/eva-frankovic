        ...
        <div className="py-10 mb-4 mt-4">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-8">
                <section className="flex-1 w-auto">
                    ...
                    <p className='pb-8'> I am a developer who primarly loves to work on the frontend, but can do some backend work as well. Outside of coding, you can find me getting a coffee, a cocktail, or hanging out with my dog.</p>
                    <Link
                        to="/about"
